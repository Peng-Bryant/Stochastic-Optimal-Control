...
class GPI:
    ...
    def evaluate_state(self, t, ix, iy, it):
    ...
    def improve_policy(self, t, ix, iy, it):
        ...
        return t, ix, iy, it, self.control_index_to_metric(min_cost_idx[0], min_cost_idx[1])
    ...
    def policy_improvement(self):
        ...
        for t in range(self.nt - 1):
            results = Parallel(n_jobs=-1)(
                delayed(self.improve_policy)(t, ix, iy, it)
                for ix, iy, it in zip(ex_indices.flatten(), ey_indices.flatten(), eth_indices.flatten())
            )

            for t, ix, iy, it, control in results:
